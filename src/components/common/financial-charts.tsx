            ...
            <ChartContainer config={chartConfig}>
               ...
               >
                  ...
                  <Area
                     ...
                     type="monotone"
                     stackId="1"
                     stroke={chartConfig.travaux_dirigé.color}
                     fillOpacity={0.4}
                     fill={chartConfig.travaux_dirigé.color}
                  />
               </AreaChart>
            </ChartContainer>
         </CardContent>
...
const ExpenseChart = () => {
   return (
      <Card className="bg-white dark:bg-gray-900">
         <CardHeader>
            <CardTitle>Dépenses Financiers - Derniers 6 Mois</CardTitle>
            <CardDescription>
               Suivi des depense par source (salaire, achat matériel, travaux).
            </CardDescription>
         </CardHeader>
         <CardContent>
            <ChartContainer config={chartConfig}>
