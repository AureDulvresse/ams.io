...
const pusher = new Pusher({
  appId: process.env.PUSHER_APP_ID || "1876257",
  key: process.env.NEXT_PUBLIC_PUSHER_APP_KEY || "ac642ac6ff9835589dde",
  secret: process.env.PUSHER_APP_SECRET || "ec0da12815a37bef1218",
