...
const LoginPage = () => {
   return (
      <div className="relative flex items-center justify-center h-screen bg-gray-50 overflow-hidden bg-cover bg-center" style={{ backgroundImage: 'url(/images/school-background.jpg)' }}>
         ...
         <div className="absolute top-24 right-24 w-[120px] h-[120px] bg-orange-400 opacity-50 animate-pulse z-10"></div>
         <div className="absolute bottom-16 left-16 w-[150px] h-[150px] bg-purple-600 opacity-40 animate-pulse z-10"></div>
         ...
         <div className="absolute bottom-5 left-1/4 w-0 h-0 border-l-[60px] border-l-transparent border-r-[60px] border-r-transparent border-b-[120px] border-b-red-500 opacity-60 animate-pulse z-10"></div>
